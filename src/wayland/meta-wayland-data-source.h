...
gpointer meta_wayland_data_source_get_toplevel_drag (MetaWaylandDataSource *source);
void     meta_wayland_data_source_set_toplevel_drag (MetaWaylandDataSource *source,
